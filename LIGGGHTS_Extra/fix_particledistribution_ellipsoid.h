...
FixStyle(particledistribution/ellipsoid,FixParticledistributionEllipsoid)

#else

#ifndef LMP_FIX_PARTICLEDISTRIBUTION_ELLIPSOID_H
#define LMP_FIX_PARTICLEDISTRIBUTION_ELLIPSOID_H
...
class FixParticledistributionEllipsoid : public Fix {
 public:
  friend class FixPourDev;
  FixParticledistributionEllipsoid(class LAMMPS *, int, char **);
  ~FixParticledistributionEllipsoid();
  ...
  { return ntemplates; }
  inline class FixTemplateEllipsoid** particletemplates()
  { return templates; }
 ...
 protected:
  ...
  int *parttogen;
  int *distorder;
  class FixTemplateEllipsoid **templates;
