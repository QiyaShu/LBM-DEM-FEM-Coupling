...
FixInsertEllipsoid::FixInsertEllipsoid(LAMMPS *lmp, int narg, char **arg) :
  Fix(lmp, narg, arg)
{
  ...
  while(iarg < narg && hasargs)
  {
    ...
    if(strcmp(arg[iarg],"distributiontemplate") == 0) {
      ...
      if(ifix < 0 || strcmp(modify->fix[ifix]->style,"particledistribution/ellipsoid"))
        error->fix_error(FLERR,this,"Fix insert requires you to define a valid ID for a fix of type particledistribution/ellipsoid");
      fix_distribution = static_cast<FixParticledistributionEllipsoid*>(modify->fix[ifix]);
      iarg += 2;
      hasargs = true;
...
FixInsertEllipsoid::~FixInsertEllipsoid()
{
  delete random;
  delete [] recvcounts;
  delete [] displs;
...
void FixInsertEllipsoid::setup(int vflag)
{
...
void FixInsertEllipsoid::init_defaults()
{
...
void FixInsertEllipsoid::sanity_check()
{
...
void FixInsertEllipsoid::print_stats_start()
{
...
void FixInsertEllipsoid::print_stats_during(int ninsert_this, double mass_inserted_this)
{
...
int FixInsertEllipsoid::setmask()
{
  int mask = 0;
  mask |= PRE_EXCHANGE;
  return mask;
...
int FixInsertEllipsoid::min_type()
{
    return type_min;
}
...
int FixInsertEllipsoid::max_type()
{
    return type_max;
}
...
double FixInsertEllipsoid::max_rad(int type)
{
...
double FixInsertEllipsoid::min_rad(int type)
{
...
double FixInsertEllipsoid::max_r_bound()
{
...
double FixInsertEllipsoid::extend_cut_ghost()
{
...
int FixInsertEllipsoid::calc_ninsert_this()
{
...
void FixInsertEllipsoid::pre_exchange()
{
...
int FixInsertEllipsoid::distribute_ninsert_this(int ninsert_this)
{
...
int FixInsertEllipsoid::count_nnear()
{
...
int FixInsertEllipsoid::load_xnear(int ninsert_this_local)
{
...
void FixInsertEllipsoid::write_restart(FILE *fp)
{
  int n = 0;
  double list[5];
...
void FixInsertEllipsoid::restart(char *buf)
{
  int n = 0;
...
double FixInsertEllipsoid::compute_vector(int index)
{
