...
#ifndef LMP_FIX_INSERTELLIPSOID_H
#define LMP_FIX_INSERTELLIPSOID_H

#include "fix.h"

namespace LAMMPS_NS {

class FixInsertEllipsoid : public Fix {
 public:
  FixInsertEllipsoid(class LAMMPS *, int, char **);
  ~FixInsertEllipsoid();
 ...
 protected:
  ...
  class FixParticledistributionEllipsoid *fix_distribution;
