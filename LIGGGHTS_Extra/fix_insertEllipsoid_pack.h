...
FixStyle(insertEllipsoid/pack,FixInsertEllipsoidPack)

#else

#ifndef LMP_FIX_INSERTELLIPSOID_PACK_H
#define LMP_FIX_INSERTELLIPSOID_PACK_H

#include "fix_insertEllipsoid.h"

namespace LAMMPS_NS {

class FixInsertEllipsoidPack : public FixInsertEllipsoid {
 public:

  FixInsertEllipsoidPack(class LAMMPS *, int, char **);
  ~FixInsertEllipsoidPack();
